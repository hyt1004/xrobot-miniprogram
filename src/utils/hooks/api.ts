...
export type UseApiOptions<F extends ApiMethod> = {
  /** 延时，为 `call`（接口调用）添加 debounce 效果 */
  delay?: number
  onError?(reason: unknown): void
  onSuccess?(data: ResultFor<F>): void
}
...
export type UseApiWithParamsOptions<F extends ApiMethod> = UseApiOptions<F> & {
