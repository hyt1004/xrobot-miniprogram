...
export default function MInput({
  label, name, type, password, placeholder, value, inputAlign, icon, iconActiveColor = primaryColor,
  disabled, required, description, extra, maxLength, leftStyle, arrow,
  className, placeholderStyle = {}, onChange, onBlur, onFocus, onConfirm
}: Props) {
